...
**Transit Data Engineer · GIS Developer · Open Source Contributor**
...
I believe cities move better when their data does too. I spend my days wrangling maps and my evenings chasing transit feeds, writing the pipelines, parsers, and dashboards that turn raw GTFS into something a city can act on.
...
## Open Source — TransitMatters

[TransitMatters](https://github.com/transitmatters) is a data-driven MBTA advocacy organization. 
| Contribution | Details |
|---|---|
| **Ferry data** | End-to-end: ingestion pipeline, GTFS processing, frontend tab, and stop/route constants |
| **Bus route expansion** | Silver Line, remaining 3-digit routes, multi-routes (434/435/436), and SLW |
...
|---|---|---|
| [gtfs_rt_rater](https://github.com/ankoure/gtfs_rt_rater) + [frontend](https://github.com/ankoure/gtfs_rt_rater_frontend) | GTFS-RT feed quality rater | Rust, TypeScript |
| [bluebike-trip-explorer](https://github.com/ankoure/bluebike-trip-explorer) | Bluebikes trip visualization | TypeScript |
| [amtrak-ingestion](https://github.com/ankoure/amtrak-ingestion) | Amtrak data pipeline | Python |
| [greenline_idletime](https://github.com/ankoure/greenline_idletime) | MBTA Green Line idle time analysis | Python |

---

## Talks & Conference Work

- **[Fall NEARC 2025](https://github.com/ankoure/FallNearc2025)** — Northeast Arc Users Group
- **[Fall NEARC 2023](https://github.com/ankoure/PythonUserManagementNEARC2023)** — Python for ArcGIS User Management
- **[PostGIS contributions](https://gitea.osgeo.org/postgis/postgis/pulls?type=all&sort=&state=open&labels=&milestone=0&project=0&assignee=0&poster=400)** — Open source GIS
